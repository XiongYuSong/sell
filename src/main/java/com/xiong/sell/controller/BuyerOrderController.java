...
import com.xiong.sell.converter.OrderForm2OrderDTOConverter;
...
import com.xiong.sell.service.BuyerService;
import com.xiong.sell.service.OrderService;
import com.xiong.sell.utils.ResultVOUtil;
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String, String>> create(@Valid OrderForm orderForm, BindingResult bindingResult) {
        ...
        //这里涉及到了OrderForm到OrderDTO的转换
        OrderDTO orderDTO = OrderForm2OrderDTOConverter.convert(orderForm);
        if (CollectionUtils.isEmpty(orderDTO.getOrderDetailList())) {
            log.error("【创建订单】 购物车不能为空");
            throw new SellException(ResultEnum.CART_EMPTY);
        }
        OrderDTO retultOrder = orderService.create(orderDTO);
        Map<String, String> map = new HashMap<>();
        map.put("orderId", retultOrder.getOrderId());
